        ...
        <form method="post" action="admin_user_verification.php" onsubmit="return submitVerificationForm(event, this)">
            <div class="verification-section">
                                    ...
                                    <div class="user-actions">
                                        <label class="checkbox-label">
                                            <input type="checkbox" name="selected_users[]"
                                                value="student_<?php echo $student['sid']; ?>" class="user-checkbox">
                ...
                <?php if ($unverified_teachers->num_rows > 0): ?>
                    <div class="user-category">
                        <h3><i class="fas fa-chalkboard-teacher"></i> Teachers (<?php echo $unverified_teachers->num_rows; ?>)
                        </h3>
                        <div class="users-grid">
                            <?php
                            // Reset pointer
                                ...
                                <div class="user-card">
                                    <div class="user-info">
                                        ...
                                        <div class="user-details">
                                            ...
                                            <p><strong>Registered:</strong>
                                                <?php
                                                if (!empty($teacher['register'])) {
                                                    $timestamp = strtotime($teacher['register']); // convert string to timestamp
                                                    echo date('M d, Y', $timestamp);
                                                } else {
                                                    echo 'Not available';
                                                }
                                            ...
                                            <?php if ($teacher['specialization']): ?>
                                                <p><strong>Specialization:</strong>
                                                    <?php echo htmlspecialchars($teacher['specialization']); ?></p>
                                            <?php endif; ?>
                                    ...
                                    <div class="user-actions">
                                        <label class="checkbox-label">
                                            <input type="checkbox" name="selected_users[]"
                                                value="teacher_<?php echo $teacher['tid']; ?>" class="user-checkbox">
                                            <span class="checkmark"></span>
                                            Select
                                        </label>
